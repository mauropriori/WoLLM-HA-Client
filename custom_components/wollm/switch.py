...
from .coordinator import WollmRuntimeData, async_set_shutdown_on_idle
...
async def async_setup_entry(
    ...
    async_add_entities([WollmShutdownOnIdleSwitch(runtime)])
...
class WollmShutdownOnIdleSwitch(WollmCoordinatorEntity, SwitchEntity):
    ...
    async def _async_set_state(self, enabled: bool) -> None:
        ...
        try:
            await async_set_shutdown_on_idle(self.runtime, enabled)
